...
import static com.example.blindfoldedcube.CubeDataStructure.Color.*;
...
import static com.example.blindfoldedcube.CubeDataStructure.Facelet.*;
...
public class FaceCube {
    ...
    public CubieCube toCubieCube() {
        ...
        for (int i = 0; i < 8; i++)
            ccRet.cp[i] = UFR;// invalidate corners
        for (int i = 0; i < 12; i++)
