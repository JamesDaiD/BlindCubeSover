...
class CoordCube {
	...
	void move(int m) {
		...
		FRtoBR = FRtoBR_Move[FRtoBR][m]; //E Turn
		UFRtoDFL = URFtoDLF_Move[UFRtoDFL][m]; //F2 Turn
		URtoUL = URtoUL_Move[URtoUL][m]; //U2 Turn
		UBtoDF = UBtoDF_Move[UBtoDF][m]; //M2 Turn
